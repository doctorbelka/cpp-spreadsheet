...
Cell::Value Cell::TextImpl::GetValue() const{
    ...
    else if (text_.at(0) == ESCAPE_SIGN) return text_.substr(1);
    else return text_;
...
Cell::FormulaImpl::FormulaImpl(std::string text, SheetInterface& sheet) : formula_(ParseFormula(text.substr(1))), sheet_(sheet){}
